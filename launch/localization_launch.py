...
def generate_launch_description():
    ...
    deliver_robot_dir = get_package_share_directory('deliver_robot')
    ...
    # ***** Urdf Node *****
    pkg_share = get_package_share_directory('deliver_robot')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(deliver_robot_dir, 'config', 'nav2_params.yaml'),
